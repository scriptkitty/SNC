 ...
 * @see FunctionIF
 */
public class NegAbsDiffFunction implements FunctionIF{
	 ...
	 * or independent version is invoked.
	 */	
	public NegAbsDiffFunction(FunctionIF first, FunctionIF second, Hoelder hoelder){
		this.first = first;
		this.second = second;
		this.firstparameters = first.getParameters();
		this.secondparameters = second.getParameters();
	 ...
	 * H�lder-coefficient) is needed to calculate the values of the
	 * resulting function.
